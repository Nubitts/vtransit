...
<body ng-app="hr" ng-controller="hrController as hr1" data-ng-init="init('BATEY')">
  <header class="header">
  ...
  <div class="d-flex align-items-stretch">
    ...
    <nav id="sidebar">
      ...
      <ul class="list-unstyled">
        ...
        <li class="active"><a href="batey.php"> <i class="icon-grid"></i>Batey </a></li>
    ...
    <div class="page-content">
      ...
      <div class="page-header no-margin-bottom">
        <div class="container-fluid">
          <h2 class="h5 no-margin-bottom">Batey</h2>
        </div>
      </div>
      <!-- Breadcrumb-->
      <div class="container-fluid">
        <ul class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Batey </li>
        </ul>
      </div>
  ...
  <script src="js/listdataba.js"></script>
