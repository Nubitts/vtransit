...
<body ng-app="hr" ng-controller="hrController as hr1" data-ng-init="init('TRANSITO')">
  <header class="header">
  ...
  <div class="d-flex align-items-stretch">
    ...
    <nav id="sidebar">
      ...
      <ul class="list-unstyled">
        ...
        <li class="active"><a href="transito.php"> <i class="icon-padnote"></i>Transito </a></li>
    ...
    <div class="page-content">
      ...
      <div class="page-header no-margin-bottom">
        <div class="container-fluid">
          <h2 class="h5 no-margin-bottom">Transito</h2>
        </div>
      </div>
      <!-- Breadcrumb-->
      <div class="container-fluid">
        <ul class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Transito </li>
        </ul>
      </div>
  ...
  <script src="js/listdatatr.js"></script>
